    ...
    <div ref={ref} className="booking-voucher">
      ...
      <div className="content">
        <div className="booking-details" style={{ display: 'flex' }}>
          ...
          <div className='booking-reference' style={{ width: '50%' }}>
            <div className="booking-id">Booking ID: <br/> {bookingDetails && bookingDetails.bookingReference }</div>
          ...
          <div className='hotel-details' style={{ width: '50%' }}>
            <div className="hotel-name">Hotel Name: {bookingDetails.property[0].property_name}</div>
            <div className="booking-date">Booking Date: {bookingDetails.updatedAt}</div>
            <div className="address">{bookingDetails.property[0].address}</div>
        ...
        <div className="content-inner" style={{ display: 'flex' }}>
          <div className='property-image' style={{ width: '40%' }}>
            {bookingDetails.property && bookingDetails.property[0] && bookingDetails.property[0].files && bookingDetails.property[0].files[0] && (
              <img
          ...
          <div className="guest-details">
            ...
            <div className="total-guests">Total Guests:  {bookingDetails.guests ? (bookingDetails.guests.length ===0 ? 1 : bookingDetails.guests) : 0}</div>
        ...
        <div className='content-signature'  style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
          {
            bookingDetails && bookingDetails.bookedBy && (
              <img className="signature" src={`${Config.BASE_URL}/storage/public/uploads/signatures/${bookingDetails.bookingReference}/${bookingDetails.signatures[0].signature}`}
               ></img>
              )
          }
      ...
      <div className="footer">
        <div className="company-info">
          <div className='vertical-break-footer'>
          </div>
